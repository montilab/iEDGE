...
---
# iEDGE-based analysis of the TCGA PAAD dataset

In this tutorial, we run iEDGE on the TCGA PAAD dataset. To achieve
reasonable run time in this vignette, we restricted the run to the
first 3 copy number alterations in the dataset.
...
for an illustration of how to preprocess datasets for TCGA pancancer
analysis
