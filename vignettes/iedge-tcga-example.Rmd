---
title: "iEDGE - tutorial with TCGA PAAD dataset"
author: "Amy Li"
...
To achieve reasonable run time in this vignette, we will subset the
run to the first 3 copy number alterations in this dataset.

For this tutorial we use a processed iEDGE object. Please see
scripts_TCGA_pancancer/1.preprocess_all_TCGA.R in the vignette folder
for an example of preprocessing of datasets for TCGA pancancer
analysis
