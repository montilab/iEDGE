...
run_dataset<-function(x, f.dir.out, header){
	cat(paste("Running GISTIC2GE for ", header, "\n", sep = ""))
...
#full results (Cis only)
	full<-list(cis.focal = x.de.cis.focal$full, 
		cis.focalorarm = x.de.cis.focalorarm$full)
...
#sig results
	sig<-list(cis.focal = x.de.cis.focal$sig, 
		cis.focalorarm = x.de.cis.focalorarm$sig, 
		trans.focal = x.de.trans.focal$sig,
		trans.focalorarm = x.de.trans.focalorarm$sig)
...
if (TRUE){
	cat("Running GISTIC2GE for lymphoma2012")
	lymph <-readRDS("/Users/amyli/Desktop/git_projects/gistic2ge_results/G2G_results_7_17_15/cancercell2012/cancercell2012_all.RDS")
	f.dir.out <- "/Users/amyli/Desktop/git_projects/gistic2ge_results/G2G_results_7_17_15/cancercell2012"
	header <- "cancercell2012"
	res1<-run_dataset(x = lymph, f.dir.out = f.dir.out, header = header)

	cat("Running GISTIC2GE for ricover2015")
	ricover <-readRDS("/Users/amyli/Desktop/git_projects/gistic2ge_results/G2G_results_7_17_15/wes_7_16_15/ricover_wes_all.RDS")
	f.dir.out<-"/Users/amyli/Desktop/git_projects/gistic2ge_results/G2G_results_7_17_15/wes_7_16_15"			
	header <- "ricover_wes"
	res2<-run_dataset(x = ricover, f.dir.out = f.dir.out, header = header)
}
